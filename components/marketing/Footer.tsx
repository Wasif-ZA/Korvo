      ...
      <div className="max-w-[1200px] mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-10 mb-16">
          <div className="max-w-lg">
            <h2 className="text-3xl md:text-4xl font-serif font-bold text-text-primary mb-3 tracking-tight">
              KORVO_
            </h2>
            <p className="text-text-secondary text-[14px] leading-relaxed font-mono opacity-80 uppercase tracking-wider">
              Precision engineering for job outreach. We find the decision
              makers, analyze multiple data sources, and draft tone-calibrated
              communications.
            </p>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-x-8 gap-y-10 mb-20">
          <div>
            ...
            <ul className="space-y-3">
              {["Features", "Data Sources", "Architecture", "Pricing"].map(
                (link) => (
                  <li key={link}>
                    <Link
                      href="#"
