...
- [ ] **Phase 8: Chat UI Reconnection** - Reconnect conversational UI to all backend infrastructure broken by UX rebuild — guest pipeline, Gmail send, Stripe redirect, legal pages, sidebar usage
